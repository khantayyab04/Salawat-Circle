export const de = {
  ...
  goalEnableHint: "Verfolge deine Beständigkeit",
  ...
  groupDetailGroupPerDay: "Gruppe braucht (Ø pro Tag)",
  ...
  groupDetailAliasOn: "Alias: an",
  groupDetailAliasOff: "Alias: aus",
  ...
  reminderJumuahPurpose:
    "Eine ruhige Erinnerung am Freitag zur von dir gewählten Uhrzeit.",
