export const de = {
  ...
  goalAdjustTitle: "Tagesziel anpassen",
  goalSaveAction: "Ziel speichern",
  goalDeactivateAction: "Ziel deaktivieren",
  conflictTitle: "Revisionskonflikt",
  conflictBody: "Dieser Eintrag wurde auf einem anderen Gerät geändert.",
  conflictKeepServer: "Serverstand behalten",
  conflictReapplyMine: "Meine Änderung erneut anwenden",
  statusPendingBadge: "Ausstehend",
  statusConflictBadge: "Konflikt",
